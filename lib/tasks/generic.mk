...
%-btbest:
	${MAKE} DATASET=${DATASET}+bt${BT_SELECTED} \
		USE_BACKTRANS_SELECTED=1 \
...
#	        ${MAKE} SRC=$$s TRG=$$t CEFILTER_RETAIN=${FT_SELECTED} extract-best-translations; \
#	      fi \
#	    fi \
#	  done \
#	done
...
## add forward translation of monolingual data with CE-filtering
%-ftmonobest:
	${MAKE} USE_FORWARDTRANSMONO_SELECTED=1 \
		DATASET=${DATASET}+ftmono${FT_SELECTED} \
		SHUFFLE_TRAINING_DATA=1 \
	${@:-ftmonobest=}
